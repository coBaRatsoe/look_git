# The name of this view in Looker is "Vw Reportapbm Graph Snp Perkabkota"
view: vw_reportapbm_graph_snp_perkabkota {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `erkam.vw_reportapbm_graphSNP_perkabkota` ;;
