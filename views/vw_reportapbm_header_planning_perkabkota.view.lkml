# The name of this view in Looker is "Vw Reportapbm Header Planning Perkabkota"
view: vw_reportapbm_header_planning_perkabkota {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `erkam.vw_reportapbm_header_planning_perkabkota` ;;
