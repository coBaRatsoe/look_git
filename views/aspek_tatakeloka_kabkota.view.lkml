# The name of this view in Looker is "Aspek Tatakeloka Kabkota"
view: aspek_tatakeloka_kabkota {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `bi-dashboard-dev.report_kinerja_madrasah.aspek_tatakeloka_kabkota` ;;
