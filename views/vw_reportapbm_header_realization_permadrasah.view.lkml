# The name of this view in Looker is "Vw Reportapbm Header Realization Permadrasah"
view: vw_reportapbm_header_realization_permadrasah {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `erkam.vw_reportapbm_header_realization_permadrasah` ;;
  ...
  dimension: status_realisasi {
    type: string
    sql: ${TABLE}.status_realisasi ;;
  }
