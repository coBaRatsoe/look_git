# The name of this view in Looker is "Vw Summary Rencanarealisasi Perkabkota"
view: vw_summary_rencanarealisasi_perkabkota {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `erkam.vw_summary_rencanarealisasi_perkabkota` ;;
