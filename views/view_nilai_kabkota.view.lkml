...
view: view_nilai_kabkota {
    ...
    sql: WITH view_nilai_provinsi AS (WITH view_aspek_pendataan_nilai_akhir AS (
          ...
          GROUP BY 1
            ...
            SELECT
                ...
                SUM(view_aspek_siswa_nilai_akhir.skor) / COUNT (view_aspek_siswa_nilai_akhir.nsm) AS total_nilai_siswa
      ...
      SELECT
          ...
          ROUND(view_nilai_provinsi.total_nilai_akhir,2)  AS view_nilai_provinsi_total_nilai_akhir,
          ROUND(view_nilai_provinsi.total_nilai_guru,2)  AS view_nilai_provinsi_total_nilai_guru,
          ROUND (view_nilai_provinsi.total_nilai_tata_kelola,2)  AS view_nilai_provinsi_total_nilai_tata_kelola,
          ROUND (view_nilai_provinsi.total_nilai_siswa,2)  AS view_nilai_provinsi_total_nilai_siswa
  ...
  view_nilai_provinsi_total_nilai_siswa
    ]
  }
}
